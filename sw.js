...
const CACHE_VERSION = "syllabus-sync-v10"; // bumped: visual-calendar-grid detector — flags MON-SUN grid PDFs with no course code and suggests uploading the syllabus instead of a silent partial result
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
