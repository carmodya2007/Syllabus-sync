...
const CACHE_VERSION = "syllabus-sync-v7"; // bumped: small-caps PDF text normalization (fixes calendar-table date parsing + garbled class names/category labels), date-segmented calendar extractor, class-name regex fix
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
